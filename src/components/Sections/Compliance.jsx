            ...
            <LeftSide>
              ...
              <ComplianceList>
                <ComplianceItem>
                  <CheckIcon>✓</CheckIcon>
                  <ItemText>
                    <strong>Accessibility & Compliance:</strong> WCAG 2.2 AA,
                    GDPR, FERMA
                  </ItemText>
                </ComplianceItem>
                <ComplianceItem>
                  <CheckIcon>✓</CheckIcon>
                  <ItemText>
                    <strong>Platform Customization:</strong> Custom dashboards,
                ...
                <ComplianceItem>
                  <CheckIcon>✓</CheckIcon>
                  <ItemText>
                    <strong>Security & Privacy:</strong> End-to-end encryption,
                    data residency in U.S.
                  </ItemText>
                </ComplianceItem>
              </ComplianceList>
              <ButtonWrapper>
