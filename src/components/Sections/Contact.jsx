      ...
      <div className='lightBg'>
        <div className='container'>
          <HeaderInfo>
            ...
            <p className='font13'>
              Get in touch with our experts to discuss how ABM Technologies can
              help
              <br />
              revolutionize your university's digital infrastructure and student
              experience.
            </p>
          </HeaderInfo>
              ...
              <SumbitWrapper className='flex'>
                <div style={{ width: "220px" }}>
                  <FullButton
                    ...
                    action={() => alert("Consultation requested!")}
                  />
                </div>
              </SumbitWrapper>
            </div>
...
const ContactImgBox = styled.div`
  ...
  &::before {
    ...
    background: linear-gradient(
      135deg,
      rgba(118, 32, 255, 0.1) 0%,
      rgba(88, 12, 210, 0.05) 100%
    );
    opacity: 0;
