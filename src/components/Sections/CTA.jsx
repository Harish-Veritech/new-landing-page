...
const CTA = () => {
  return (
    <section class='relative overflow-hidden bg-gradient-to-t from-[#0B1437] to-[#0E1B50] py-24 flex justify-center my-32'>
      <Circle classname='w-48 h-48 absolute -bottom-5 -left-10 ' />
      <Circle classname='w-44 h-44 absolute -bottom-18 left-24 ' />
      <Circle classname='w-44 h-44 absolute -top-14 right-0 ' />
      <Circle classname='w-56 h-56 absolute top-12 right-8 ' />

      <div class='relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl px-8 py-10 md:px-10 md:py-12 shadow-2xl max-w-4xl mx-auto w-full'>
