...
const CTA = () => {
  return (
    <section class='relative overflow-hidden bg-gradient-to-t from-[#0B1437] to-[#0E1B50] py-24 flex justify-center my-0 lg:my-32 px-8'>
      ...
      <div class='relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 bg-white/5 backdrop-blur-md border border-white/50 rounded-xl px-8 py-10 md:px-10 md:py-12 shadow-2xl max-w-5xl mx-auto w-full'>
        <h2 class='text-xl md:text-3xl font-semibold text-white text-center md:text-left leading-snug'>
